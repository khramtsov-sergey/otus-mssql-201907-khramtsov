...
GO
PRINT N'Creating [//WMI/SB/ReplyMessage]...';


GO
CREATE MESSAGE TYPE [//WMI/SB/ReplyMessage]
    AUTHORIZATION [dbo]
    VALIDATION = WELL_FORMED_XML;


GO
PRINT N'Creating [//WMI/SB/RequestMessage]...';


GO
CREATE MESSAGE TYPE [//WMI/SB/RequestMessage]
    AUTHORIZATION [dbo]
    VALIDATION = WELL_FORMED_XML;


GO
PRINT N'Creating [dbo].[InitiatorQueueWMI]...';


GO
CREATE QUEUE [dbo].[InitiatorQueueWMI];


GO
PRINT N'Creating [dbo].[TargetQueueWMI]...';


GO
CREATE QUEUE [dbo].[TargetQueueWMI];


GO
PRINT N'Creating [//WMI/SB/Contract]...';


GO
CREATE CONTRACT [//WMI/SB/Contract]
    AUTHORIZATION [dbo]
    ([//WMI/SB/RequestMessage] SENT BY INITIATOR, [//WMI/SB/ReplyMessage] SENT BY TARGET);


GO
PRINT N'Creating [//InitiatorService]...';


GO
CREATE SERVICE [//InitiatorService]
    AUTHORIZATION [dbo]
    ON QUEUE [dbo].[InitiatorQueueWMI]
    ([//WMI/SB/Contract]);


GO
PRINT N'Creating [//WMI/SB/TargetService]...';


GO
CREATE SERVICE [//WMI/SB/TargetService]
    AUTHORIZATION [dbo]
    ON QUEUE [dbo].[TargetQueueWMI]
    ([//WMI/SB/Contract]);
