...
GO
PRINT N'Creating [//Iventory/SB/ReplyMessage]...';


GO
CREATE MESSAGE TYPE [//Iventory/SB/ReplyMessage]
    AUTHORIZATION [dbo]
    VALIDATION = WELL_FORMED_XML;


GO
PRINT N'Creating [//Iventory/SB/RequestMessage]...';


GO
CREATE MESSAGE TYPE [//Iventory/SB/RequestMessage]
    AUTHORIZATION [dbo]
    VALIDATION = WELL_FORMED_XML;


GO
PRINT N'Creating [dbo].[TargetQueueIventory]...';


GO
CREATE QUEUE [dbo].[TargetQueueIventory];


GO
PRINT N'Creating [//Iventory/SB/Contract]...';


GO
CREATE CONTRACT [//Iventory/SB/Contract]
    AUTHORIZATION [dbo]
    ([//Iventory/SB/RequestMessage] SENT BY INITIATOR, [//Iventory/SB/ReplyMessage] SENT BY TARGET);


GO
PRINT N'Creating [//Iventory/SB/TargetService]...';


GO
CREATE SERVICE [//Iventory/SB/TargetService]
    AUTHORIZATION [dbo]
    ON QUEUE [dbo].[TargetQueueIventory]
    ([//Iventory/SB/Contract]);
