...
ALTER TABLE [dbo].[Contract]
    ADD CONSTRAINT [FK_Contract_Company] FOREIGN KEY ([CompanyID]) REFERENCES [dbo].[Company] ([Id]);
...
GO
ALTER TABLE [dbo].[Contract]
    ADD CONSTRAINT [FK_Contract_Supplier] FOREIGN KEY ([SupplierID]) REFERENCES [dbo].[Supplier] ([Id]);
